...
export default {
  ...
  methods: {
    ...
    handleExportPrize() {
      let head = ["序号", "作品类别", "命题名称", "参赛编号", "作品名称", "作者", "作者电话", "指导教师", "教师电话", "学校", "院系", "专业", "获奖等级"];
      let filter = ["seq", "works_type", "works_series_name", "wno", "works_name", "author1", "tel", "t_uname", "t_tel", "school", "department", "major", "prize"];
