    ...
    return {
      ...
      rules: [
        ...
        },
        {
          type: "4",
          name: "视频类（影视、微电影）",
          desc: "<p>（1）作品类型为影视广告或带有故事情节的微电影广告。</p><p>（2）拍摄工具及制作软件不限，影视广告时间：60秒以内。微电影广告180秒以内。作品存储为mpg或avi格式，分辨率不低于720×576，不要倒计时。</p><p>（3）要求提交作品文件名为：视频类-姓名-作品名称-单位。</p><p>（4）作品结尾处展示“2022河北省公益广告大赛”的组合标识（标识素材从大赛官网下载）。</p><p>（5）每组参赛人员不得超过5人。</p>"
        },
        {
          type: "5",
          name: "动画类（移动端、电视）",
