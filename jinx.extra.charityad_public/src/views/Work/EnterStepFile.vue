      ...
      rules: [
        {
          type: "1",
          name: "平面类（移动端、传统媒体）",
          desc: "<p>（1）数量要求：移动端静态广告，作品可超过6幅，可排版在3张画面上；传统媒体发布的静态广告，作品不超过3幅。</p><p>（2）提交文件格式为jpg，规格A3（297×420mm），分辨率300dpi。</p><p>（3）色彩模式为CMYK模式（用于线下印刷展览，作品大小小于10MB）。</p><p>（4）要求提交作品文件名为：平面类-姓名-作品名称-单位。</p><p>（5）作品右下角须标明“2022河北省公益广告大赛”的组合标识（标识素材从大赛官网下载）。</p><p>（6）每组参赛人员不得超过3人。</p>"
        },
        {
          type: "2",
          name: "文案类",
