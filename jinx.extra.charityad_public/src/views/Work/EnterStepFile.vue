      ...
      rules: [
        {
          type: "1",
          name: "平面类（移动端、传统媒体）",
          desc: "<p>（1）数量要求：移动端静态广告，作品可超过6幅，可排版在3张画面上；传统媒体发布的静态广告，作品不超过3幅。</p><p>（2）提交文件格式为jpg，规格A3（297×420mm），分辨率300dpi。</p><p>（3）色彩模式为CMYK模式（用于线下印刷展览，作品大小小于10MB）。</p><p>（4）要求提交作品文件名为：平面类-姓名-作品名称-单位。</p><p>（5）作品右下角须标明“2021河北省公益广告大赛”的组合标识（标识素材从大赛官网下载）。</p><p>（6）每组参赛人员不得超过3人。</p>"
        },
        {
          type: "2",
          name: "文案类",
        ...
        },
        {
          type: "4",
          name: "视频类（影视、微电影）",
          desc: "<p>（1）作品类型为影视广告或带有故事情节的微电影广告。</p><p>（2）拍摄工具及制作软件不限，影视广告时间：15秒或30秒。微电影广告180秒以内。作品存储为mpg或avi格式，分辨率不低于720×576，不要倒计时。</p><p>（3）要求提交作品文件名为：视频类-姓名-作品名称-单位。</p><p>（4）作品结尾处展示“2021河北省公益广告大赛”的组合标识（标识素材从大赛官网下载）。</p><p>（5）每组参赛人员不得超过5人。</p>"
        },
        {
          type: "5",
          name: "动画类（移动端、电视）",
          desc:
            "<p>（1）移动端：符合移动端发布的动画广告作品，时间30秒以内。（推荐使用iH5平台制作，其他平台亦可）</p><p>（2）电视端：符合电视及电脑发布的动画广告作品。</p><p>（3）创作方式及制作软件不限，作品要符合动画广告的概念。24帧/秒，时间30秒以内，配音、配乐，系列作品不得超过3件，画面宽度600—960像素，不要倒计时。 </p><p>（4）要求提交作品文件名为：动画类-姓名-作品名称-单位。</p><p>（5）作品结尾处展示“2021河北省公益广告大赛”的组合标识（标识素材从大赛官网下载）。</p><p>（6）每组参赛人员不得超过5人。</p>"
        },
        {
          type: "6",
          name: "互动类（移动端、场景互动）",
          desc:
            "<p>（1）互动广告包括移动端（手机）iH5互动广告和场景互动广告（不限位置）。</p><p>（2）作品的格式：</p><p>①移动端（手机）iH5互动广告 </p><p>a、用iH5平台（www.iH5.cn）制作线上互动广告。可以为H5动画，H5游戏，H5电子杂志，H5交互视频等。 </p><p>b、作品分辨率要适合手机屏幕尺寸，即默认页面宽度640px，高度可以为1008px、1030px，页数不多于15页。 </p><p>c、作品需提交作品的链接及二维码，并提交作品链接和电子文档, 要求提交作品文件名为：互动类-姓名-作品名称-单位。</p><p>②场景互动广告以iH5文件形式加以演示说明，并提交作品链接，要求提交作品文件名均为：互动类-姓名-作品名称-单位。</p><p>（3）作品结尾处展示“2021河北省公益广告大赛”的组合标识（标识素材从大赛官网下载）。</p><p>（4）每组参赛人员不得超过4人。</p>"
        }
      ],
      type: "平面类",
      rule: ""
